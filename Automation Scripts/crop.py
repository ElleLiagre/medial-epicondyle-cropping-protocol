...
#        the Medial Epicondyle of the Humerus - Python Script for Cropping
# 
...
# Date: 2025-03-24
# 
# Description: Crops the humeral medial epicondyle as described in the  
# associated article. Specify the model’s file path, or if omitted, a 
# window will prompt you to select one. Instructions are provided when 
# the function runs. Note: This function is for right humeri only due 
# to orientation requirements. If run for a left-sided model, the 
# humeral diaphysis will be extracted instead of the medial epicondyle.
